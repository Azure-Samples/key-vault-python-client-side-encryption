...
class KeyVaultSampleConfig(object):
    ...
    :ivar storage_account_key: Azure storage account key for the specified storage account 
    :vartype group_name: str
    """
    ...
    def __init__(self):
        ...
        self.group_name = os.getenv(
            'AZURE_RESOURCE_GROUP', 'azure-sample-group')
        self.storage_account_name = os.getenv(
            'AZURE_STORAGE_ACCOUNT_NAME', 'xxxx')
        self.storage_account_key = os.getenv(
            'AZURE_STORAGE_ACCOUNT_KEY', 'yyyy')
